...
<div class="container">
    ...
    <div class="row clearfix">
        ...
        <div class="col-md-4 column">
            <form role="form" action="/fore_foreUser_login" method="post">
                <div class="form-group">
                    <label for="exampleInputEmail1">用户:</label><input type="text" class="form-control" name="username" id="exampleInputEmail1" />
                </div>
                <div class="form-group">
