...
<div class="container">
    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            ...
            <span><a href="/fore_foreProduct_cList?id=${category.id}&sort=price">价格排序</a></span>
            <span><a href="/fore_foreProduct_cList?id=${category.id}&sort=sale">销量排序</a></span>
            <span><a href="/fore_foreProduct_cList?id=${category.id}&sort=reviewCount">评价数量排序</a></span>
            <hr>
        </div>
    </div>
    <div class="row clearfix">
